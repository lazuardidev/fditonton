...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when insert to database is success',
      ...
      // act
      final result = await dataSource.insertMoviesToWatchlist(testMovieTable);
      // assert
    ...
    test('should throw DatabaseException when insert to database is failed',
      ...
      when(mockDatabaseHelper.insertWatchlistMovie(testMovieTable))
          .thenThrow(Exception());
      // act
      final call = dataSource.insertMoviesToWatchlist(testMovieTable);
      // assert
  ...
  group('remove watchlist', () {
    test('should return success message when remove from database is success',
      ...
      when(mockDatabaseHelper.removeWatchlistMovie(testMovieTable))
          .thenAnswer((_) async => 1);
      // act
      final result = await dataSource.removeMoviesFromWatchlist(testMovieTable);
      // assert
    ...
    test('should throw DatabaseException when remove from database is failed',
      ...
      when(mockDatabaseHelper.removeWatchlistMovie(testMovieTable))
          .thenThrow(Exception());
      // act
      final call = dataSource.removeMoviesFromWatchlist(testMovieTable);
      // assert
      expect(() => call, throwsA(isA<DatabaseException>()));
    });
  });
